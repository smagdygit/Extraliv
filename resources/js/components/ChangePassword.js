		...
		<center>
			<Segment className="m-3">
				...
				<div className="text-left">
					<h4>Krav:</h4>
					<p>Minst 20 karaktärer långt<br />Du får inte välja ett lösenord du har på någon annan webbplats<br />Välj något säkert, våra kunders integritet står på spel<br /><br /></p>
					...
					<h4 className={newUserPass.length < 20 ? "text-danger" : "text-success"}>{newUserPass.length} / 20{error}</h4>
					<Input
						type='password'
						className="mb-3"
						fluid
